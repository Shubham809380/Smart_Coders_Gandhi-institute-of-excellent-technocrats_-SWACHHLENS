...
const seedUsers = [
  ...
  { uid: "user-admin", name: "Command Center Admin", email: "admin@swachhlens.com", phone: "+919812340000", role: ROLES.SUPER_ADMIN, ward_id: "ward-north", location_name: "Region North" },
...
const seedPasswords = { "user-citizen": "citizen123", "user-admin": "admin@swachhlens.com", "user-worker": "worker123" };
