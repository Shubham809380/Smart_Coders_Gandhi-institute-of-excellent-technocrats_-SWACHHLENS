...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--adm-bg)", color: "var(--adm-text)" }}>
      ...
      {/* Main column — `isolate` creates a stacking context so Leaflet panes (z-400+)
          and map overlays can never paint above the fixed sidebar (z-40). */}
      <div className="lg:pl-60 isolate flex flex-col min-h-screen">
